...
<body>
    <div id="Container">
        <nav>
            <ul class="nav_menus">
                <li><a href="01-mainIndex.html" class="main_logo"><img src="${pageContext.request.contextPath}/resources/images/logo.svg" width="120px" height="28px" alt=""></a></li>
                <li><a href="#">about</a></li>
                <li><a href="#">news</a></li>
                <li class="dropmenu item1"><a href="#">store</a>
                    <ul class="submenu1">
            ...
            <ul class="nav_icons">
                <li><a href="#"><i class="xi-log-in"></i></a></li>
         ...
         <div class="joinFormCon">

          <div class="joinForm">
           
            <ul>
                <li><div class="topTitle"> 
                    <div><span>아이디</span><img src=" ${pageContext.request.contextPath}/resources/images/btn/star_point.png" alt=""></div><span>(영문소문자/숫자, 4~16자)</span>
                </div>
                <input type="text" id="id" name="id"></li>

                
                <li><div class="topTitle">
                    <div><span>비밀번호</span><img src=" ${pageContext.request.contextPath}/resources/images/btn/star_point.png" alt=""></div><span>(영문 대소문자/숫자/특수문자 중 2가지 이상 조합, 8자~16자)
                        
                    </span>
                </div>
                <input type="password" id="pw" name="pw"></li>

                <li><div class="topTitle">
                    <div><span>비밀번호 확인</span><img src=" ${pageContext.request.contextPath}/resources/images/btn/star_point.png" alt=""></div>
                   
                        
                   
                </div>
                <input type="password" id="pw2" name="pw2"></li>
                <li><p class="errorMsg">  </p></li>
                <li>

                </li>
                <li><div class="nameTopTitle ">
                    <div ><span>이름</span><img src="${pageContext.request.contextPath}/resources/images/btn/star_point.png" alt=""></div>
                ...
                <li><div class="emailTopTitle">
                    <div><span>이메일</span><img src="${pageContext.request.contextPath}/resources/images/btn/star_point.png" alt=""></div>
                   
                    <div class="emailCon"><input type="email" id="email" name="email"><span class="emailError"></span>
                </div>
            </div>
                </li>
            </ul>
            <h3>전체 동의</h3>
             <div class="checkList">
                 <div class="topCon">
                     <div class="allCheckCon">
                         <input type="checkbox" name="mustCheck" id="allCheck"><strong>이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong></div>
                    <div class="mustCheckCon1">
                        <p>[필수] 이용약관 동의</p>
                        <div class="content">
                            <p>제1조(목적)<br>
                            ...
                            <p>제5조(서비스의 중단)<br>
                                ...
                                ③ 사업종목의 전환, 사업의 포기, 업체 간의 통합 등의 이유로 서비스를 제공할 수 없게 되는 경우에는 “몰”은 제8조에 정한 방법으로 이용자에게 통지하고 당초 “몰”에서 제시한 조건에 따라 소비자에게 보상합니다. 다만, “몰”이 보상기준 등을 고지하지 아니한 경우에는 이용자들의 마일리지 또는 적립금 등을 “몰”에서 통용되는 통화가치에 상응하는 현물 또는 현금으로 이용자에게 지급합니다.</p>
                            <p>제6조(회원가입)<br>
                            ...
                            <p>제9조(구매신청)<br>
                                ① “몰”이용자는 “몰”상에서 다음 또는 이와 유사한 방법에 의하여 구매를 신청하며, “몰”은 이용자가 구매신청을 함에 있어서 다음의 각 내용을 알기 쉽게 제공하여야 합니다.
                                  ...
                                  6. 결제방법의 선택
                                ② “몰”이 제3자에게 구매자 개인정보를 제공·위탁할 필요가 있는 경우 실제 구매신청 시 구매자의 동의를 받아야 하며, 회원가입 시 미리 포괄적으로 동의를 받지 않습니다. 이 때 “몰”은 제공되는 개인정보 항목, 제공받는 자, 제공받는 자의 개인정보 이용 목적 및 보유·이용 기간 등을 구매자에게 명시하여야 합니다. 다만 「정보통신망이용촉진 및 정보보호 등에 관한 법률」 제25조 제1항에 의한 개인정보 처리위탁의 경우 등 관련 법령에 달리 정함이 있는 경우에는 그에 따릅니다.</p>
                            <p>제10조 (계약의 성립)<br>
                            ...
                            <p>제12조(수신확인통지.구매신청 변경 및 취소)<br>
                                ...
                                ② 수신확인통지를 받은 이용자는 의사표시의 불일치 등이 있는 경우에는 수신확인통지를 받은 후 즉시 구매신청 변경 및 취소를 요청할 수 있고 “몰”은 배송 전에 이용자의 요청이 있는 경우에는 지체 없이 그 요청에 따라 처리하여야 합니다. 다만 이미 대금을 지불한 경우에는 제15조의 청약철회 등에 관한 규정에 따릅니다.</p>
                            <p>제13조(재화 등의 공급)<br>
                            ...
                            <p>제14조(환급)<br>
                                “몰”은 이용자가 구매신청한 재화 등이 품절 등의 사유로 인도 또는 제공을 할 수 없을 때에는 지체 없이 그 사유를 이용자에게 통지하고 사전에 재화 등의 대금을 받은 경우에는 대금을 받은 날부터 3영업일 이내에 환급하거나 환급에 필요한 조치를 취합니다.</p>
                            <p>제15조(청약철회 등)<br>
                            ...
                            <p>제16조(청약철회 등의 효과)<br>
                                ...
                                ④ 이용자가 재화 등을 제공받을 때 발송비를 부담한 경우에 “몰”은 청약철회 시 그 비용을 누가 부담하는지를 이용자가 알기 쉽도록 명확하게 표시합니다.</p>
                            <p>제17조(개인정보보호)<br>
                                ...
                                ⑨ “몰”은 개인정보의 수집·이용·제공에 관한 동의란을 미리 선택한 것으로 설정해두지 않습니다. 또한 개인정보의 수집·이용·제공에 관한 이용자의 동의거절시 제한되는 서비스를 구체적으로 명시하고, 필수수집항목이 아닌 개인정보의 수집·이용·제공에 관한 이용자의 동의 거절을 이유로 회원가입 등 서비스 제공을 제한하거나 거절하지 않습니다.</p>
                            <p>제18조(“몰“의 의무)<br>
                            ...
                            <p>제21조(연결“몰”과 피연결“몰” 간의 관계)<br>
                                ...
                                ② 연결“몰”은 피연결“몰”이 독자적으로 제공하는 재화 등에 의하여 이용자와 행하는 거래에 대해서 보증 책임을 지지 않는다는 뜻을 연결“몰”의 초기화면 또는 연결되는 시점의 팝업화면으로 명시한 경우에는 그 거래에 대한 보증 책임을 지지 않습니다.</p>
                            ...
                            <p>제23조(분쟁해결)<br>
                                ...
                                ③ “몰”과 이용자 간에 발생한 전자상거래 분쟁과 관련하여 이용자의 피해구제신청이 있는 경우에는 공정거래위원회 또는 시·도지사가 의뢰하는 분쟁조정기관의 조정에 따를 수 있습니다.</p>
                            <p>제24조(재판권 및 준거법)<br>
             ...
             <div id="submitCon"> <a id="submit" href="#">회원가입</a>  </div>
        ...
        <footer>
            <div class="footerinner">
                ...
                <ul class="footer bottom">
                    <li>Company. 어니언컴퍼니 Owner. 유주형 Tel. 02-1644-1941 E-mail. onion@onionkr.com Address. 04797 서울특별시 성동구
                        아차산로9길 8 (성수동2가) 1,2층</li>
                ...
                <a href="https://www.instagram.com/cafe.onion/">instagram</a>
            </div>
        </footer>
     <span class="topbtn"><i class="xi-long-arrow-up"></i></span>
    </div>
    ...
    <script>
        ...
        /* 이메일 창에 입력후 이메일형식이 아니면 오류메세지를 출력하는 이벤트*/
        $("#email").keyup(function(e){
            ...
            let regxp =RegExp(/^[A-Za-z0-9_\.\-]+@[A-Za-z0-9\-]+\.[A-Za-z0-9\-]+/);
              ...
              if(e.keyCode===13){
                ...
                if(!(regxp.test($(this).val()))){
                    $(this).addClass("on_error");
                    $(".login_state_msg").addClass("active");
                    $(".login_state_msg").text("이메일 주소의 형식이 맞지 않습니다.");
                    setTimeout(function(){ 
                    $(".login_state_msg").removeClass("active");
                    $(".login_state_msg").text("");
                    $("#user_login_email").removeClass("on_error");}
                    ,3000)
            ...
            $("#allCheck").click(function(){
                if($(this).is(":checked")){
             $("#mustCheck1").prop("checked",true);
             $("#mustCheck2").prop("checked",true);
             $("#choose1").prop("checked",true);
             $("#choose2").prop("checked",true);
            }else{
            $("#mustCheck1").prop("checked",false);
             $("#mustCheck2").prop("checked",false);
            ...
            //     if ($(this).scrollTop() > 0) {
            //         $("section .aboutimg").addClass("on");

            //     } else {
            //         $("section .aboutimg").removeClass("on");
            //     }
            // });
            $(window).scroll(function (){
                if ($(this).scrollTop() > 50) {
                    $("#Container .topbtn").addClass("on");

                } else {
                    $("#Container .topbtn").removeClass("on");
                }
            });

            $("#Container .topbtn").click(function(){
            ...
            $("#Container>nav li a").hover(function(){
           ...
           $(".nav_icons>li>a>.xi-log-in").click(function(e){
               e.preventDefault();
              location.href="01-mainIndex.html";
